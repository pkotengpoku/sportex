  ...
  return (
    <div>
      <div className='w-full rounded-full mx-auto py-3 pr-3 pl-8 justify-between flex h-16 min-h-fit border border-slate-300 shadow max-w-screen'>
        ...
        <div className='bg-amber-300 rounded-full h-full w-10 md:w-12 md:h-12 justify-center flex flex-shrink-0'> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.1} stroke="currentColor" className="size-6 m-auto">

...
export default function SuccessPage() {
  ...
  // In a real application, you'd fetch the checkout session details 
  // on the server *using the sessionId* to confirm the payment
  // and display order details securely.
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 text-center">
      ...
      <p className="text-gray-500">
        ...
        <code className="bg-gray-100 p-1 rounded text-sm block mt-2">{sessionId || 'N/A'}</code>
      </p>
      <a 
        href="/" 
